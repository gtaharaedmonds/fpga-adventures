...
#[doc = "Field `TRNG_CTRL_FIFO_CLR` reader - Clear data FIFO when set (flag auto clears)"]
pub type TrngCtrlFifoClrR = crate::BitReader;
...
#[doc = "Field `ONEWIRE_CTRL_FIFO_SIZE` reader - log2(TRNG FIFO size)"]
pub type OnewireCtrlFifoSizeR = crate::FieldReader;
...
impl R {
    ...
    #[inline(always)]
    pub fn trng_ctrl_fifo_clr(&self) -> TrngCtrlFifoClrR {
        TrngCtrlFifoClrR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bits 2:5 - log2(TRNG FIFO size)"]
    #[inline(always)]
    pub fn onewire_ctrl_fifo_size(&self) -> OnewireCtrlFifoSizeR {
        OnewireCtrlFifoSizeR::new(((self.bits >> 2) & 0x0f) as u8)
    }
...
impl W {
    #[doc = "Bit 0 - TRNG enable flag"]
    #[inline(always)]
    pub fn trng_ctrl_en(&mut self) -> TrngCtrlEnW<CtrlSpec> {
        TrngCtrlEnW::new(self, 0)
    }
    #[doc = "Bit 1 - Clear data FIFO when set (flag auto clears)"]
    #[inline(always)]
    pub fn trng_ctrl_fifo_clr(&mut self) -> TrngCtrlFifoClrW<CtrlSpec> {
