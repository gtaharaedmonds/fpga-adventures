...
#[doc = "Field `SPI_DATA` reader - RX/TX data (via FIFOs)"]
pub type SpiDataR = crate::FieldReader;
#[doc = "Field `SPI_DATA` writer - RX/TX data (via FIFOs)"]
pub type SpiDataW<'a, REG> = crate::FieldWriter<'a, REG, 8>;
#[doc = "Field `SPI_DATA_CMD` reader - SPI TX data (0) / command (1) select"]
pub type SpiDataCmdR = crate::BitReader;
#[doc = "Field `SPI_DATA_CMD` writer - SPI TX data (0) / command (1) select"]
pub type SpiDataCmdW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bits 0:7 - RX/TX data (via FIFOs)"]
    #[inline(always)]
    ...
    #[inline(always)]
    pub fn spi_data_cmd(&self) -> SpiDataCmdR {
        SpiDataCmdR::new(((self.bits >> 31) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:7 - RX/TX data (via FIFOs)"]
    ...
    #[doc = "Bit 31 - SPI TX data (0) / command (1) select"]
    #[inline(always)]
    pub fn spi_data_cmd(&mut self) -> SpiDataCmdW<DataSpec> {
