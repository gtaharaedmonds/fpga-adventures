...
#[doc = "Field `WDT_RESET` reader - Write password to reset/feed the watchdog (0x709D1AB3)"]
pub type WdtResetR = crate::FieldReader<u32>;
...
impl R {
    ...
    #[inline(always)]
    pub fn wdt_reset(&self) -> WdtResetR {
        WdtResetR::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - Write password to reset/feed the watchdog (0x709D1AB3)"]
    #[inline(always)]
    pub fn wdt_reset(&mut self) -> WdtResetW<ResetSpec> {
