...
#[doc = "Field `GPTMR_CTRL_IRQ_CLR` reader - Set to clear timer-match interrupt"]
pub type GptmrCtrlIrqClrR = crate::BitReader;
...
impl R {
    ...
    #[inline(always)]
    pub fn gptmr_ctrl_irq_clr(&self) -> GptmrCtrlIrqClrR {
        GptmrCtrlIrqClrR::new(((self.bits >> 30) & 1) != 0)
    }
...
impl W {
    #[doc = "Bit 0 - Timer enable flag"]
    #[inline(always)]
    pub fn gptmr_ctrl_en(&mut self) -> GptmrCtrlEnW<CtrlSpec> {
        GptmrCtrlEnW::new(self, 0)
    }
    #[doc = "Bits 1:3 - Clock prescaler select"]
    #[inline(always)]
    pub fn gptmr_ctrl_prsc(&mut self) -> GptmrCtrlPrscW<CtrlSpec> {
        GptmrCtrlPrscW::new(self, 1)
    }
    #[doc = "Bit 30 - Set to clear timer-match interrupt"]
    #[inline(always)]
    pub fn gptmr_ctrl_irq_clr(&mut self) -> GptmrCtrlIrqClrW<CtrlSpec> {
