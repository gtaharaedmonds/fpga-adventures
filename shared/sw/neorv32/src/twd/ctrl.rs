...
#[doc = "Field `TWD_CTRL_CLR_RX` reader - Clear RX FIFO, flag auto-clears"]
pub type TwdCtrlClrRxR = crate::BitReader;
#[doc = "Field `TWD_CTRL_CLR_RX` writer - Clear RX FIFO, flag auto-clears"]
pub type TwdCtrlClrRxW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TWD_CTRL_CLR_TX` reader - Clear TX FIFO, flag auto-clears"]
pub type TwdCtrlClrTxR = crate::BitReader;
...
#[doc = "Field `TWD_CTRL_FIFO` reader - log2(TWD FIFO size)"]
pub type TwdCtrlFifoR = crate::FieldReader;
...
impl R {
    ...
    #[inline(always)]
    pub fn twd_ctrl_clr_rx(&self) -> TwdCtrlClrRxR {
        TwdCtrlClrRxR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Clear TX FIFO, flag auto-clears"]
    #[inline(always)]
    pub fn twd_ctrl_clr_tx(&self) -> TwdCtrlClrTxR {
        TwdCtrlClrTxR::new(((self.bits >> 2) & 1) != 0)
    }
    ...
    #[doc = "Bits 15:18 - log2(TWD FIFO size)"]
    #[inline(always)]
    pub fn twd_ctrl_fifo(&self) -> TwdCtrlFifoR {
        TwdCtrlFifoR::new(((self.bits >> 15) & 0x0f) as u8)
    }
...
impl W {
    #[doc = "Bit 0 - TWD enable flag"]
    #[inline(always)]
    pub fn twd_ctrl_en(&mut self) -> TwdCtrlEnW<CtrlSpec> {
        TwdCtrlEnW::new(self, 0)
    }
    #[doc = "Bit 1 - Clear RX FIFO, flag auto-clears"]
    #[inline(always)]
    pub fn twd_ctrl_clr_rx(&mut self) -> TwdCtrlClrRxW<CtrlSpec> {
        TwdCtrlClrRxW::new(self, 1)
    }
    #[doc = "Bit 2 - Clear TX FIFO, flag auto-clears"]
    #[inline(always)]
    pub fn twd_ctrl_clr_tx(&mut self) -> TwdCtrlClrTxW<CtrlSpec> {
        TwdCtrlClrTxW::new(self, 2)
    }
    #[doc = "Bit 3 - Bus sample clock / filter select"]
    #[inline(always)]
    pub fn twd_ctrl_fsel(&mut self) -> TwdCtrlFselW<CtrlSpec> {
        TwdCtrlFselW::new(self, 3)
    }
    #[doc = "Bits 4:10 - Device address (7-bit)"]
    #[inline(always)]
    pub fn twd_ctrl_dev_addr(&mut self) -> TwdCtrlDevAddrW<CtrlSpec> {
        TwdCtrlDevAddrW::new(self, 4)
    }
    #[doc = "Bit 11 - IRQ if RX FIFO data available"]
    #[inline(always)]
    pub fn twd_ctrl_irq_rx_avail(&mut self) -> TwdCtrlIrqRxAvailW<CtrlSpec> {
        TwdCtrlIrqRxAvailW::new(self, 11)
    }
    #[doc = "Bit 12 - IRQ if RX FIFO full"]
    #[inline(always)]
    pub fn twd_ctrl_irq_rx_full(&mut self) -> TwdCtrlIrqRxFullW<CtrlSpec> {
        TwdCtrlIrqRxFullW::new(self, 12)
    }
    #[doc = "Bit 13 - IRQ if TX FIFO empty"]
    #[inline(always)]
    pub fn twd_ctrl_irq_tx_empty(&mut self) -> TwdCtrlIrqTxEmptyW<CtrlSpec> {
