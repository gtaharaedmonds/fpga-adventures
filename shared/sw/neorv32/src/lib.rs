#![doc = "Peripheral access API for NEORV32 microcontrollers (generated using svd2rust v0.35.0 (e100619 2025-03-09))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next] svd2rust release can be generated by cloning the svd2rust [repository], checking out the above commit, and running `cargo doc --open`.\n\n[here]: https://docs.rs/svd2rust/0.35.0/svd2rust/#peripheral-api\n[next]: https://github.com/rust-embedded/svd2rust/blob/master/CHANGELOG.md#unreleased\n[repository]: https://github.com/rust-embedded/svd2rust"]
#![allow(warnings)]
...
pub static __EXTERNAL_INTERRUPTS: [Vector; 16] = [
    ...
    Vector {
        _handler: UART0_RX_FIRQ,
    },
    Vector {
        _handler: UART0_TX_FIRQ,
    },
    Vector {
        _handler: UART1_RX_FIRQ,
    },
    Vector {
        _handler: UART1_TX_FIRQ,
    },
    ...
    Vector {
        _handler: SLINK_RX_FIRQ,
    },
    Vector {
        _handler: SLINK_TX_FIRQ,
    },
];
#[doc(hidden)]
pub mod interrupt;
...
#[doc = "Direct memory access controller"]
pub mod dma;
#[doc = "Cyclic redundancy check unit"]
pub type Crc = crate::Periph<crc::RegisterBlock, 0xffee_0000>;
