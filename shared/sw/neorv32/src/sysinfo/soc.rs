...
#[doc = "Field `SYSINFO_SOC_MEM_INT_IMEM` reader - Processor-internal instruction memory implemented"]
pub type SysinfoSocMemIntImemR = crate::BitReader;
#[doc = "Field `SYSINFO_SOC_MEM_INT_DMEM` reader - Processor-internal data memory implemented"]
pub type SysinfoSocMemIntDmemR = crate::BitReader;
...
#[doc = "Field `SYSINFO_SOC_XBUS_CACHE` reader - External bus cache implemented"]
pub type SysinfoSocXbusCacheR = crate::BitReader;
...
#[doc = "Field `SYSINFO_SOC_IO_UART0` reader - Primary universal asynchronous receiver/transmitter 0 implemented"]
...
#[doc = "Field `SYSINFO_SOC_IO_UART1` reader - Secondary universal asynchronous receiver/transmitter 1 implemented"]
...
#[doc = "Field `SYSINFO_SOC_IO_CRC` reader - Cyclic redundancy check unit implemented"]
pub type SysinfoSocIoCrcR = crate::BitReader;
impl R {
    ...
    #[inline(always)]
    pub fn sysinfo_soc_mem_int_imem(&self) -> SysinfoSocMemIntImemR {
        SysinfoSocMemIntImemR::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - Processor-internal data memory implemented"]
    #[inline(always)]
    pub fn sysinfo_soc_mem_int_dmem(&self) -> SysinfoSocMemIntDmemR {
        SysinfoSocMemIntDmemR::new(((self.bits >> 3) & 1) != 0)
    }
    ...
    #[doc = "Bit 8 - External bus cache implemented"]
    #[inline(always)]
    pub fn sysinfo_soc_xbus_cache(&self) -> SysinfoSocXbusCacheR {
        SysinfoSocXbusCacheR::new(((self.bits >> 8) & 1) != 0)
    }
    ...
    #[doc = "Bit 17 - Primary universal asynchronous receiver/transmitter 0 implemented"]
    #[inline(always)]
    ...
    #[doc = "Bit 25 - Secondary universal asynchronous receiver/transmitter 1 implemented"]
    #[inline(always)]
    ...
    #[doc = "Bit 31 - Cyclic redundancy check unit implemented"]
    #[inline(always)]
    pub fn sysinfo_soc_io_crc(&self) -> SysinfoSocIoCrcR {
        SysinfoSocIoCrcR::new(((self.bits >> 31) & 1) != 0)
    }
}
