...
impl R {
    ...
    #[doc = "Bits 16:23 - Number of physical CPU cores"]
    #[inline(always)]
    pub fn sysinfo_misc_hart(&self) -> SysinfoMiscHartR {
        SysinfoMiscHartR::new(((self.bits >> 16) & 0xff) as u8)
    }
    #[doc = "Bits 24:31 - Boot mode configuration select"]
    #[inline(always)]
    pub fn sysinfo_misc_boot(&self) -> SysinfoMiscBootR {
        SysinfoMiscBootR::new(((self.bits >> 24) & 0xff) as u8)
    }
}
