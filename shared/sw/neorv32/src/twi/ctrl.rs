...
impl W {
    #[doc = "Bit 0 - TWI enable flag"]
    #[inline(always)]
    pub fn twi_ctrl_en(&mut self) -> TwiCtrlEnW<CtrlSpec> {
        TwiCtrlEnW::new(self, 0)
    }
    #[doc = "Bits 1:3 - Clock prescaler select"]
    #[inline(always)]
    pub fn twi_ctrl_prsc(&mut self) -> TwiCtrlPrscW<CtrlSpec> {
        TwiCtrlPrscW::new(self, 1)
    }
    #[doc = "Bits 4:7 - TWI clock divider"]
    #[inline(always)]
    pub fn twi_ctrl_cdiv(&mut self) -> TwiCtrlCdivW<CtrlSpec> {
        TwiCtrlCdivW::new(self, 4)
    }
    #[doc = "Bit 8 - Enable (allow) clock stretching"]
    #[inline(always)]
    pub fn twi_ctrl_clkstr(&mut self) -> TwiCtrlClkstrW<CtrlSpec> {
