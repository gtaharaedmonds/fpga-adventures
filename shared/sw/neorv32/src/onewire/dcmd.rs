...
#[doc = "Field `ONEWIRE_DCMD_CMD` reader - Operation command"]
pub type OnewireDcmdCmdR = crate::FieldReader;
...
impl R {
    ...
    #[inline(always)]
    pub fn onewire_dcmd_cmd(&self) -> OnewireDcmdCmdR {
        OnewireDcmdCmdR::new(((self.bits >> 8) & 3) as u8)
    }
...
impl W {
    #[doc = "Bits 0:7 - RTX data, transmitted LSB-first"]
    #[inline(always)]
    pub fn onewire_dcmd_data(&mut self) -> OnewireDcmdDataW<DcmdSpec> {
        OnewireDcmdDataW::new(self, 0)
    }
    #[doc = "Bits 8:9 - Operation command"]
    #[inline(always)]
    pub fn onewire_dcmd_cmd(&mut self) -> OnewireDcmdCmdW<DcmdSpec> {
