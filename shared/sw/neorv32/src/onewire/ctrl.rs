...
#[doc = "Field `ONEWIRE_CTRL_CLEAR` reader - Clear RXT FIFO, auto-clears"]
pub type OnewireCtrlClearR = crate::BitReader;
...
impl R {
    ...
    #[inline(always)]
    pub fn onewire_ctrl_clear(&self) -> OnewireCtrlClearR {
        OnewireCtrlClearR::new(((self.bits >> 1) & 1) != 0)
    }
...
impl W {
    #[doc = "Bit 0 - ONEWIRE controller enable"]
    #[inline(always)]
    pub fn onewire_ctrl_en(&mut self) -> OnewireCtrlEnW<CtrlSpec> {
        OnewireCtrlEnW::new(self, 0)
    }
    #[doc = "Bit 1 - Clear RXT FIFO, auto-clears"]
    #[inline(always)]
    pub fn onewire_ctrl_clear(&mut self) -> OnewireCtrlClearW<CtrlSpec> {
        OnewireCtrlClearW::new(self, 1)
    }
    #[doc = "Bits 2:3 - Clock prescaler select"]
    #[inline(always)]
    pub fn onewire_ctrl_prsc(&mut self) -> OnewireCtrlPrscW<CtrlSpec> {
        OnewireCtrlPrscW::new(self, 2)
    }
    #[doc = "Bits 4:11 - Clock divider"]
    #[inline(always)]
    pub fn onewire_ctrl_clkdiv(&mut self) -> OnewireCtrlClkdivW<CtrlSpec> {
