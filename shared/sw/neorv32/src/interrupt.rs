...
pub enum Interrupt {
    ...
    #[doc = "13 - ONEWIRE_FIRQ"]
    ONEWIRE_FIRQ = 13,
    #[doc = "14 - SLINK_RX_FIRQ"]
    SLINK_RX_FIRQ = 14,
    #[doc = "15 - SLINK_TX_FIRQ"]
    SLINK_TX_FIRQ = 15,
}
...
impl Interrupt {
    ...
    pub fn try_from(value: u8) -> Result<Self, TryFromInterruptError> {
        match value {
            ...
            2 => Ok(Interrupt::UART0_RX_FIRQ),
            3 => Ok(Interrupt::UART0_TX_FIRQ),
            4 => Ok(Interrupt::UART1_RX_FIRQ),
            5 => Ok(Interrupt::UART1_TX_FIRQ),
            ...
            14 => Ok(Interrupt::SLINK_RX_FIRQ),
            15 => Ok(Interrupt::SLINK_TX_FIRQ),
