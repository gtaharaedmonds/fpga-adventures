...
set_property -dict { PACKAGE_PIN C12   IOSTANDARD LVCMOS33 } [get_ports { cpu_nrst }]; #IO_L3P_T0_DQS_AD1P_15 Sch=cpu_resetn

# set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { sys_clk }]; #IO_L9P_T1_DQS_14 Sch=btnc
